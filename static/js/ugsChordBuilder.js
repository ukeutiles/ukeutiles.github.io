...
ugsChordBuilder.settings = (function() {
	...
	var cursor = {
		fillColor: 'rgba(31, 141, 214, 0.35)',
		strokeWidth: 2,
		strokeColor: '#1f8dd6',
		radius: 11,
		imageUri: '/static/img/hand-cursor.png'
	};
	...
	var fretLabel = {
		...
		fontSize: 18, // Pixels
		color: '#222222',
		lightColor: '#eeeeee' //D6D6D6' //A4A4A3'
	};
...
ugsChordBuilder.chordCanvas = (function() {
	...
	var addLabels = function(startingFret) {
		var pos = new ents.Position(
			anchor_pos.x - 0.7 * opt_fLabel.fontSize,
			anchor_pos.y + 8 + opt_fLabel.fontSize
		);
